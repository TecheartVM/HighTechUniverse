...
public class BlockSteamBoiler extends HTUTileBlock
{
    ...
    @Nullable
    @Override
    public TileEntity createTileEntity(BlockState state, IBlockReader world) { return RegistryHandler.STEAM_BOILER.getMainBlock().getMachineTile().create(); }
