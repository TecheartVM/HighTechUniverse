...
public class TileEntitySensorFluidLevel extends TileEntity implements ITickableTileEntity
{
    ...
    public boolean updateTarget()
    {
        ...
        measurementTarget = te.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY).orElse(null);
    ...
    public void tick()
    {
        if(world == null || world.isRemote()  || measurementTarget == null) return;
